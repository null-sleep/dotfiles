...
local keywords = {
  ...
  ['<leader>bx'] = 'close buffer delete bufremove split keep window',
  ...
  ['<leader>up'] = 'update plugins packages vim.pack upgrade lockfile PackUpdate',
  ...
  ['<leader>co'] = 'output run rerun re-run last runnable target no picker again split buffer rust go cargo',
...
local tags = {
  ...
  ['<leader>vf'] = { 'diff' },
  ['<leader>vq'] = { 'diff' },
  ['<leader>uu'] = { 'diff', 'undo/redo' }, -- desc derives 'utilities'; it previews diffs and belongs with u/<C-r>
