...
## Go Private
export GOPRIVATE=github.com/example-org/*,github.com/work/*
...
GOPRIVATE=github.com/example-org/*,github.com/work/*
...
# BG Admin
alias bga='/Users/dhruvjauhar/src/admin-tools/bin/admintool'
